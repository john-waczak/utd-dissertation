...
assumes Lambertian scattering as previously described in Section~\ref{sec:imaging}.
...
\item The HSI is converted to reflectance.
...
instead of capturing an image by sampling light across an array of sensors, the
